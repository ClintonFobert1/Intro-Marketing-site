...
load_theme_textdomain( 'intro-theme', get_template_directory() . '/languages' );
...
// Define THEME_IMG_PATH constant
if( !defined('THEME_IMG_PATH')){
    define( 'THEME_IMG_PATH', get_stylesheet_directory_uri() . '/assets/img/content' );
}

// Define THEME_JS_PATH constant
if( !defined('THEME_JS_PATH')){
    define( 'THEME_JS_PATH', get_stylesheet_directory_uri() . '/assets/js' );
}

// Define THEME_CSS_PATH constant
if( !defined('THEME_CSS_PATH')){
    define( 'THEME_CSS_PATH', get_stylesheet_directory_uri() . '/assets/css' );
}

// Define THEME_CSSSHEET_PATH constant
if( !defined('THEME_CSSSHEET_PATH')){
    define( 'THEME_CSSSHEET_PATH', get_stylesheet_directory_uri() . '/' );
}
